...
void shutdown(bool turnOffLEDs, bool allowWakeupWithBuzzer) {
        ...
        esp_deep_sleep_enable_gpio_wakeup(
            ...
            | (esp_sleep_is_valid_wakeup_gpio((gpio_num_t)BACK_BUTTON_PIN) ? (1 << BACK_BUTTON_PIN) : 0),
        ...
        while ((allowWakeupWithBuzzer && digitalRead(BUZZER_BUTTON_PIN) == LOW) || digitalRead(BACK_BUTTON_PIN) == LOW) { yield(); }
        delay(50);
